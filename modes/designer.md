...
description: >
  ...
  Use after /strategist produces a strategy, or when designing any new product experience.
---
...
- After `/strategist` produces STRATEGY.md
...
1. LOAD STRATEGY
   ...
   If not found: "No STRATEGY.md found. Run /strategist first, or describe 

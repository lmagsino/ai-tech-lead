...
**Produces:** `STRATEGY.md` in the project root — the product constitution that feeds `/design`, `/challenge`, and all engineering modes.

**Next mode:** `/design` — reads STRATEGY.md, designs the product experience.
...
9. RECOMMENDATION
   ...
   - GO: The idea has a real problem, credible differentiation, a monetization path, 
     and a distribution hypothesis. Proceed to /design with STRATEGY.md.
...
```
User: /strategy "I want to build an AI writing tool"
...
```
User: /strategy "An AI tool for restaurant owners to manage inventory"

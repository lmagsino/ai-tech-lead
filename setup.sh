...
install_claude_code() {
  ...
  echo ""
  echo "  Usage:"
  echo "    /athena challenge \"Should we build X?\""
  echo "    /athena spec \"Feature description\""
  echo "    /athena guard src/"
  echo "    /athena forge specs/feature.md"
...
echo "  Modes: /challenge /spec /forge /investigate /guard /vision /evolve /patch /retro"
echo ""
